...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function cfc(e) {
        document.querySelector('.header-chat .main-friend-chat').insertAdjacentHTML("beforeend", '' +
            ...
            '</div>' +
            '<a class="media-right photo-table" href="#"><img class="media-object img-radius img-radius m-t-5" src="public/assets/images/user/avatar-1.jpg" alt="Generic placeholder image"></a>' +
            '</div>' +
            '');
    ...
    function frc(wrmsg) {
        setTimeout(function() {
            document.querySelector('.header-chat .main-friend-chat').insertAdjacentHTML("beforeend", '' +
                ...
                '<a class="media-left photo-table" href="#"><img class="media-object img-radius img-radius m-t-5" src="public/assets/images/user/avatar-2.jpg" alt="Generic placeholder image"></a>' +
