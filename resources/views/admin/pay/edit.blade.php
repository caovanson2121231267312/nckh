    ...
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Hình thức thanh toán</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
                            <li class="breadcrumb-item"><a href="#">Sửa hình thức thanh toán</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-md-6">
                        <h5 class="mt-5">Sửa hình thức thanh toán</h5>
                        <hr>
                        <form action="{{route('pay.edit',['id'=>$data->id])}}" method="post">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Hình thức thanh toán : </label>
                                <div class="col-sm-9">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name='content' value="{{$data->content}}" class="form-control" id="inputEmail3">
                                </div>
                            </div>
