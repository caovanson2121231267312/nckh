                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Thêm vị trí mới</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html"><i class="feather icon-home"></i></a></li>
                            {{-- <li class="breadcrumb-item"><a href="#">Form Components</a></li> --}}
                            <li class="breadcrumb-item"><a href="{{route('users.add')}}">Thêm vị trí mới</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="{{route('store.add')}}" method="post">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name='map' class="form-control" id="inputEmail3">
                                </div>
                            </div>
