    ...
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Thêm bài viết</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
                            <li class="breadcrumb-item"><a href="{{route('categories.add')}}">Thêm bài viết</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-md-12">
                        <h5 class="mt-5">Thêm bài viết</h5>
                        <hr>
                        <form action="{{route('blog.add')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name='file' required class="form-control" id="inputEmail3">
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <div class="col-sm-9">
                                    <input type="text" hidden value="{{Auth::user()->id}}" name="user_id" required class="form-control" id="inputEmail3">
                                </div>
                            </div>
                            <div class="mb-3">
