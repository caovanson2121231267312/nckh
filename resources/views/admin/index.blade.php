                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card bg-c-blue order-card">
                        <div class="card-body">
                            ...
                            <h2 class="text-end text-white"><i class="feather icon-shopping-cart float-start"></i><span>{{$ordersReceived}}</span></h2>
                            <p class="m-b-0">Completed Orders<span class="float-end">{{$orders}}</span></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
