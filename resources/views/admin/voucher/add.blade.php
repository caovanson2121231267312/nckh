                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Thêm voucher</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
                            <li class="breadcrumb-item"><a href="{{route('categories.add')}}">Thêm voucher</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="{{route('voucher.add')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name='content' required class="form-control" id="inputEmail3">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="inputEmail3" class="col-sm-3">Giảm giá : </label>
                                <div class="col-sm-9">
                                    <input type="text" name='sale' required class="form-control" id="inputEmail3">
                                </div>
                            </div>
                            <div class="mb-3">
