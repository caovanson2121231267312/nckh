                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Danh sách voucher</h5>
                        </div>
                        <ul class="breadcrumb">
...
{{$value->title}}
                                        ...
                                        <td>
                                            <div>
                                                <img class="img-n" style="width:62px;border-radius: 5px;" src="{{asset('assets/upload/'.$value->img)}}">
                                        </td>
                                        <td>
                                            {{$value->sale}}
                                        </td>
                                        ...
                                        <td>
                                            <a href="{{route('voucher.edit',['id'=>$value->id])}}">
                                                <i class="icon feather icon-edit f-16  text-c-green"></i>
                                            </a>
                                            <a href="{{route('voucher.delete',['id'=>$value->id])}}" data-url="" class="">
