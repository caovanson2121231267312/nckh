 <div class="featured__phone grid wide">
     ...
     @endforeach
     @if ($p == 0)
         <div style="text-align: center;color: #F50F0F;font-size: 24px;">Chưa có sản phẩm nào thuộc doanh mục bạn đang
             chọn</div>
     @endif
 ...
 <a class="btn-show-more btn-load-more cta-xem-san-pham" onclick="ale()">Xem
     thêm <i class="fas fa-chevron-down"></i></a>
